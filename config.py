...
class Config:
    ...
    NIM_TEMPERATURE = float(os.environ.get("NIM_TEMPERATURE", "0.5"))
    NIM_CONTEXT_WINDOW_TOKENS = int(os.environ.get("NIM_CONTEXT_WINDOW_TOKENS", "2048"))
    NIM_MAX_RPM = int(os.environ.get("NIM_MAX_RPM", "30"))  # Requests per minute rate limiting
